...
In addition to significant personal costs, obese people, on average, receive more healthcare than other people, with taxpayers funding most of the costs of those services.
...
This tax would raise about \$500~million a year, generate a drop of about 15 per cent in consumption of SSBs and likley result in a small decrease in obesity rates, as people switch to water and other drinks not subject to the tax. 
...
But it is important to reduce the consumption of SSBs because most contain little or no nutritional benefit, they are consumed heavily by children, and Australia’s added-sugar intake is already high.
...
\units{\% of total burden attributable to top risk factors, 2011}
...
For example, the Australian Food and Grocery Council, the processed food industry body, has been a full member of the government's Preventative Health Taskforce and dietary guidelines committee.} Experts also argue that governments have not committed enough money to obesity interventions and prevention policies.%
...
\units{\% adults with BMI of 30 or more}

\includegraphics[page=3]{atlas/ObesityCharts}

%\notes{measured BMI (30 or more)}
...
\footcites{RepresentativesStandingCommitteeonHealth2009Weighingitup}{Medibank2011SickWorkcost} As a result, employers face higher employment costs and lower productivity than otherwise, reducing profits and therefore the tax revenue received by Commonwealth Government (an estimated \$0.1~billion).
...
\footnote{Based findings in  \textcite{Woodward-Lopez2010whatextenthave}, see \Vref{sec:consumption-of-ssbs-contributes-to-the-third-party-costs-of-obesity}.} A new tax is justified because the market has failed: the obesity epidemic is imposing a heavy cost burden on governments and non-obese Australians.
...
An SSB tax along these lines will initially generate around \$500~million a year in revenue, recover some of the third-party costs of consumption that contributes to obesity, and reduce the consumption of SSBs by increasing the retail price, and lead to a small reduction in obesity rates.
...
Sugar content is the link to obesity and related costs, so an SSB tax should be targeted at the sugar contained within drinks.\footnote{\textcite{Bonnet2013Taxincidencestrategic} state that `an excise tax based on the sugar content is the most effective way to limit SD consumption.
...
\item
  The second-best tax option, if implementing a sugar content tax is too difficult, is an tiered volumetric tax based on sugar content.
\end{itemize}
...
\notes{Tiered volumetric tax is 20 cents/litre SSBs with sugar content \textless{}8g/100mL; 40 cents/litre with sugar content \textgreater{}8g/100mL}
...
Low-income households spend a higher proportion of their disposable income on SSBs (but less in absolute terms), so an SSB tax will likely be regressive -- they will pay a higher proportion of their income in tax (\Vref{fig:High-income-households-spend-the-most-on-SSBs}).%
...
Modelling of SSB taxes in Australia and overseas generally finds that population weight falls modestly and obesity prevalence declines after the introduction of a tax, with a larger impact on heavy consumers of SSBs and people with low incomes.%
...
Also in an Australian context, \textcite{Sacks2011Statesshouldstand} modelled a 10 per cent junk food tax and found energy intake would fall by 174 and 121kJ per day for males and females, respectively.
...
\notes{Tiered volumetric tax 20c/litre on SSBs with sugar content \textless{}8g/100mL; 40c/litre with sugar content \textgreater{}8g/100mL}
...
But an SSB tax will reduce consumption, partly reduce the third-party costs of SSB consumption which contributes to obesity and likely lead to a modest decline in obesity prevalence.
...
The impact of an SSB tax on the sugar industry will also be minimal, as a small amount of sugar previously sold to domestic SSB producers will instead need to be exported, although there may be localised transition costs instead be exported (see \Vref{box:impactSSBindustry}).
...
\onecolumn
\chapter{Sugar-sweetened beverages tax literature review summary}\label{appendix-1-ssb-tax-literature-review-summary}
...
\notes{Tiered volumetric tax is 20 cents/litre on SSBs with sugar content \textless{}8g/100mL; 40 cents/litre sugar content \textgreater{}8g/100mL}
